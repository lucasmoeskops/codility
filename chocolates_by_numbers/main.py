...
The goal is to count the number of chocolates that you will eat, following the above
rules.
...
For example, given integers N = 10 and M = 4. the function should return 5, as explained
above.
