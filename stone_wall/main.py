...
H[0] is the height of the wall's left end and H[N−1] is the height of the wall's right
end.
...
For example, given array H containing N = 9 integers:
  ...
  H[3] = 7    H[4] = 9    H[5] = 8
  H[6] = 7    H[7] = 4    H[8] = 8
the function should return 7. The figure [figure-1.png] shows one possible arrangement of
seven blocks.
...
def solution(H):
    ...
    blocks = 0
    for height in H:
        while stack and stack.top() > height:
            stack.pop()

        if stack and stack.top() == height:
            continue
